...
namespace Bancomer
{
        ...
        where R : BancomerResourceObject
    {
        ...
        public BancomerResourceService(string api_key, string merchant_id, bool production = false)
        {
            this.httpClient = new BancomerHttpClient(api_key, merchant_id, production);
        }

        internal BancomerResourceService(BancomerHttpClient opHttpClient)
        {
