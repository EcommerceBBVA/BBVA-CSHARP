...
namespace Bbva
{
    public class BbvaHttpClient
    {
        ...
        private static readonly string user_agent = "Bbva .NET v1";
        ...
        public BbvaHttpClient(string api_key, string merchant_id, bool production = false)
        {
            ...
            catch (WebException wexc)
            {
                if (wexc.Response != null)
                {
                    ...
                    if ((int)status_code <= 500)
                        throw BbvaException.GetFromJSON(status_code, json_error);
                }
                throw;
            }
            return result;
